...
describe('market candle query limits', () => {
  it.each([1, 30, 150, 1000, 1400, 1600, 1800, 2000, 2001])('binds validated limit %i as MySQL-compatible decimal text', async limit => {
  ...
  it.each([0, -1, 1.5, NaN, Infinity, 2002])('rejects invalid limit %s before querying', async limit => {
