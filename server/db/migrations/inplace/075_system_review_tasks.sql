CREATE TABLE IF NOT EXISTS system_review_tasks_v4 (
  ...
  KEY idx_system_review_tasks_due (status,next_attempt_at_utc,history_task_id),
  CONSTRAINT fk_system_review_tasks_history FOREIGN KEY (history_task_id) REFERENCES history_collection_tasks_v4 (id)
