    ...
    try {
      ...
      for (const row of rows) {
        ...
        if (row.pending_valid_until) {
          // pending_valid_until is UTC string (generated by normalizeAiSignal via toISOString)
