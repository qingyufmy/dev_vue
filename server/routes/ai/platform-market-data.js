...
async function maybeCleanupMarketData() {
  ...
  for (const [timeframe, days] of Object.entries(RETENTION_DAYS)) {
    ...
    await queryRun(`DELETE candles FROM market_candles candles
      ...
      AND NOT EXISTS (
        ...
        WHERE benchmark_set.status = 'active' AND benchmark_set.symbol = candles.standard_symbol
