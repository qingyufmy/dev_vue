...
export async function traderWindowStaleReason(clock: AccountClockReader, connection: PoolConnection, run: TraderRun, preferences: (connection: PoolConnection) => SubscriptionPreferencesReader): Promise<string | null> {
