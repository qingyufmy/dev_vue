...
export { validHistoryQueryCoverage, type HistoryQueryCoverage } from './domain/history-query-coverage.js'
...
export { BridgeInstrumentCollector } from './application/bridge-instrument-collector.js'
export { BridgeInstrumentWorker } from './application/bridge-instrument-worker.js'
