    ...
    switch (action) {
      ...
      case 'history': {
        ...
        if (bridgeOk) {
          ...
          bridgeParams.date_to = params.close_to || new Date(Date.now() + 86400000).toISOString().slice(0, 10)
      ...
      case 'history_chart_data': {
        ...
        if (bridgeOk) {
          ...
          chartParams.date_to = params.close_to || new Date(Date.now() + 86400000).toISOString().slice(0, 10)
