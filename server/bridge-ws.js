              ...
              try {
                ...
                for (const k of keys) {
                  ...
                  schedulers.push({
                    ...
                    schedule_interval_minutes: Number(state.schedule_interval_minutes || state.interval_minutes || 5),
                    ...
                    slot_start_lag_ms: Number(state.slot_start_lag_ms || 0),
                    last_skipped_slot_id: state.last_skipped_slot_id || '',
                    last_skipped_slot_reason: state.last_skipped_slot_reason || '',
                    skipped_slot_count: Number(state.skipped_slot_count || 0),
                  ...
                  if (totalSubs > 0) {
                    ...
                    if (memState) {
                      schedulers.push({
                        ...
                        schedule_mode: memState.scheduleMode || 'completion_interval',
                        schedule_interval_minutes: memState.scheduleIntervalMinutes || memState.intervalMinutes || db.interval_minutes || 5,
                        current_slot_id: memState.currentSlotId || '',
                        current_slot_boundary_utc: memState.currentSlotBoundaryUtc || '',
                        current_slot_boundary_terminal: memState.currentSlotBoundaryTerminal || '',
                        next_run_in_seconds: memState.nextRunInSeconds || 0,
                        next_run_at_utc: memState.nextRunAtUtc || '',
                        next_run_at_terminal: memState.nextRunAtTerminal || '',
                        slot_start_lag_ms: memState.slotStartLagMs || 0,
                        last_skipped_slot_id: memState.lastSkippedSlotId || '',
                        last_skipped_slot_reason: memState.lastSkippedSlotReason || '',
                        skipped_slot_count: memState.skippedSlotCount || 0,
