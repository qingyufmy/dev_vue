"""Upgrade current development history tables after restored-database evidence checks."""
import json
...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/apply-history-runtime-upgrade-local.mjs'),
                                 *sys.argv[1:]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'history_runtime_current_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
