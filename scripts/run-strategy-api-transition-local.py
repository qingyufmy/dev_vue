...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/verify-strategy-api-transition-local.mjs'),
                                 sys.argv[1]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'strategy_api_transition_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
