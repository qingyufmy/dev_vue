...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/verify-instrument-snapshot-schema-reference-local.mjs'),
                                 sys.argv[1]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'strategy_budget_reference_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
