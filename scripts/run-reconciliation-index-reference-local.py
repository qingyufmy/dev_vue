"""Verify the reconciliation index on an owned full-schema reference through an ephemeral VM SSH tunnel."""
import json
...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/verify-reconciliation-index-reference-local.mjs'),
                                 sys.argv[1]],
