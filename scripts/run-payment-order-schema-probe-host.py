"""Create payment_orders and test constraints in the development reference schema."""
import json
import os
...
def main():
    ...
    try:
        ...
        script = Path(__file__).resolve().with_name('probe-payment-order-schema-host.mjs')
