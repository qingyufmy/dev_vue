...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/verify-instrument-schema-reference-local.mjs'),
                                 '--temporary-reference-only', sys.argv[1]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'instrument_schema_receipt_reference_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
