import { createAccountPrincipalReader, assertAccountPrincipalReadSchemaV2 } from '../server/dist-v4/modules/auth/composition.js'
import assert from 'node:assert/strict'
import { open, readFile } from 'node:fs/promises'
import { isAbsolute } from 'node:path'
import { parse } from 'dotenv'
import { createMysqlPool } from '../server/dist-v4/bootstrap/runtime-resources.js'
import { assertTradingSchemaReady, createTransactionTradingReader } from '../server/dist-v4/modules/trading/composition.js'
...
try {
  ...
  await assertTradingSchemaReady(pool, assertAccountPrincipalReadSchemaV2)
