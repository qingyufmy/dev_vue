...
import { executeReferralRuleUpgrade } from './lib/execute-referral-rule-upgrade.mjs'
...
try {
  ...
  const result = await executeReferralRuleUpgrade(connection, { database: 'dev_vue_m1_source_20260907_02', apply: true, injectAfterDdl: true })
