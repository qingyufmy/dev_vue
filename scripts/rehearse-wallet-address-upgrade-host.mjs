...
import { executeWalletAddressUpgrade } from './lib/execute-wallet-address-upgrade.mjs'
...
try {
  ...
  const result = await executeWalletAddressUpgrade(connection, { database: 'dev_vue_m1_source_20260907_02', apply: true, injectAfterDdl: true })
