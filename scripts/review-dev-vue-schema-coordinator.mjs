...
try {
  ...
  const report = await withInplaceUpgradeLock(connection, 'dev_vue', async () => {
    ...
    try {
      ...
      return { kind: 'inplace-schema-coordinator-review/v1', identity, result,
  ...
  const target = new URL('docs/migration/dev-vue-schema-coordinator-review-20260907.json', root)
