"""Apply the verified quote provenance upgrade only to the development database through an ephemeral VM SSH tunnel."""
import json
...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/apply-quote-provenance-local.mjs'),
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'quote_current_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
