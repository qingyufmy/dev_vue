...
const additions = ['scripts/lib/mysql-observer-context-migration.mjs', 'scripts/lib/observer-context-coordinator.mjs',
  ...
  'scripts/rehearse-observer-context-migration-local.mjs', 'docs/architecture/observer-context-reference-20260908.json']
...
export async function mysqlObserverContextMigrationStore(connection, plan, root, proofPath, priorProofPath, rootProofPath) {
  ...
  const reference = JSON.parse(await readFile(new URL('docs/architecture/observer-context-reference-20260908.json', root), 'utf8'))
