...
import { freezeLegacyCandleBuildTools } from './mysql-legacy-candle-build-migration.mjs'
...
const additions = ['scripts/lib/legacy-candle-backfill-proof.mjs', 'scripts/lib/legacy-candle-backfill.mjs',
  ...
  'docs/architecture/legacy-candle-conversion-rehearsal-20260908-v4.json', 'server/routes/ai/platform-market-data.js']
