...
import { freezeLegacyCandlePromotionTools, mysqlLegacyCandlePromotionStore } from './mysql-legacy-candle-promotion.mjs'
...
const referencePath = 'docs/architecture/context-receipt-schema-reference-20260908-v2.json'
...
export function prepareContextChangesProof(plan, identity, priorProof, priorSnapshot, reference, tools, priorHistory) {
  check(hash(identity) === hash(priorProof.identity), 'prior_identity')
