...
import { mysqlObserverContextMigrationStore, freezeObserverContextTools } from './mysql-observer-context-migration.mjs'
...
const additions = ['scripts/lib/mysql-account-projection-migration.mjs', 'scripts/lib/account-projection-coordinator.mjs',
  ...
  'scripts/rehearse-account-projection-migration-local.mjs', 'docs/architecture/account-projection-reference-20260908.json']
...
export async function mysqlAccountProjectionMigrationStore(connection, plan, root, proofPath, priorProofPath, terminalProofPath, rootProofPath) {
  ...
  const reference = JSON.parse(await readFile(new URL('docs/architecture/account-projection-reference-20260908.json', root), 'utf8'))
