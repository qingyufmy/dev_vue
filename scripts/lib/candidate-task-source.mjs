...
export async function loadCandidateTaskSource(root) {
  const path = 'server/db/migrations/inplace/074_manual_candidate_tasks.sql', bytes = await readFile(new URL(path, root))
