...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/verify-strategy-write-reference-local.mjs'),
                                 '--parent-dispatch-reference-only', sys.argv[1]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'strategy_write_reference_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
