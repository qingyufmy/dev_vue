...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/backup-risk-dev-vue-local.mjs'),
                                 '--execute', *sys.argv[1:]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'risk_backup_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
