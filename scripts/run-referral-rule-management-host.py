...
The probe is limited to the isolated dev_vue_m1_a reference database.
"""
import json
import os
import re
...
def main():
    ...
    try:
        ...
        script = os.path.join(os.path.dirname(os.path.abspath(__file__)), "probe-referral-rule-management-host.mjs")
