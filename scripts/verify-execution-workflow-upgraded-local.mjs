...
try{
 ...
 await assertMysqlExecutionWorkflowSchemaReady(scoped(current))
 report.checks.push('current-240-step-database-43-table-gate-passed')
 await assertMysqlExecutionWorkflowSchemaReady(scoped(restored))
 report.checks.push('restored-240-step-database-43-table-gate-passed')
