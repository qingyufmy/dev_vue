...
try {
  ...
  try {
    ...
    let versions = 0, foreignOwnerRejections = 0
    ...
    Object.assign(report, { passed: true, cases: cases.length, currentVersions: versions, foreignOwnerRejections, originalTextVerified: true, utcReadVerified: true })
