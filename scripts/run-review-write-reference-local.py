...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/verify-review-write-reference-local.mjs'),
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'review_write_reference_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
