...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/verify-entry-event-reference-local.mjs'),
                                 sys.argv[1]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'entry_event_reference_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
