"""Apply the rehearsed inference build upgrade to the development database through an ephemeral VM SSH tunnel."""
import json
...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/apply-inference-build-local.mjs'),
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'inference_build_current_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
