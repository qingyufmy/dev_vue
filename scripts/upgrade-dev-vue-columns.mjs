...
try {
  ...
  console.log(JSON.stringify({ ...result, database: 'dev_vue', needsJournal: !hasJournal, executable: false, sqlFile: fileURLToPath(new URL('server/db/migrations/inplace/002_user_bridge_columns.sql', root)) }))
} catch (error) {
