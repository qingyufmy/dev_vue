...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/rehearse-reconciliation-index-local.mjs'),
                                 sys.argv[1]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'reconciliation_index_rehearsal_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
