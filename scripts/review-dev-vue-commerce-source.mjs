...
const path = 'docs/migration/dev-vue-commerce-source-review-20260907.json'
...
try {
  ...
  const report = { kind: 'commerce-source-review/v1', identity, schemaSteps: plan.steps.length,
