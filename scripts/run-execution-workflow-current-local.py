...
def main():
    ...
    try:
        ...
        result = subprocess.run(['node', str(root / 'scripts/apply-execution-workflow-current-local.mjs'),
                                 sys.argv[1]],
...
if __name__ == '__main__':
    try:
        ...
        print(json.dumps({'passed': False, 'code': 'execution_workflow_current_orchestration_failed', 'kind': type(error).__name__}))
        sys.exit(1)
