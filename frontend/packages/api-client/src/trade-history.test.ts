...
describe('trade history API client', () => {
  it('encodes stable filters and detail ids on normalized V4 routes', async () => {
    ...
    const responses = [
      { data: { captured_end: meta.generated_at, freshness: { status: 'empty', history_revision: '0', fresh_through: null, last_success_at: null }, items: [], next_cursor: null, has_more: false, summary: { trade_count: 0, winning_count: 0, losing_count: 0, breakeven_count: 0, win_rate_percent: null, gross_profit: '0', commission: '0', swap: '0', fee: '0', net_profit: '0', profit_factor: null }, daily: [] }, meta },
      { data: { id: 'trade/1', account_id: '42', platform: 'mt5', primary_ticket: '1001', position_id: null, symbol: 'XAUUSD', side: 'buy', status: 'closed', source: 'unknown', attribution_status: 'unresolved', evidence_status: 'partial', volume: '0.10', entry_price: '2500', exit_price: '2510', stop_loss: null, take_profit: null, gross_profit: '10', commission: '0', swap: '0', fee: '0', net_profit: '10', opened_at: '2026-09-04T07:00:00.000Z', closed_at: '2026-09-04T07:30:00.000Z', terminal_timezone_offset_minutes: 180, revision: '1', evidence_hash: 'a'.repeat(64), deals: [], attributions: [] }, meta },
    ]
