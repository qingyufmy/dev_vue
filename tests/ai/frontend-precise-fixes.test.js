...
describe('precise AI/admin frontend fixes', () => {
  ...
  it('requests ten users per page without changing other admin pagination', async () => {
    ...
    expect(adminHtml).toContain('/admin/app.js?v=20260811frontend2')
  })
  ...
  it('ships cache-busted app scripts while keeping each asset family on one key', () => {
    expect(aiHtml).toContain('/ai/app.js?v=20260811frontend2&build=signalbandwidth1-notifications1')
    expect(aiHtml).toContain('/ai/styles.css?v=20260811frontend2')
    expect(aiHtml).toContain('/ai/responsive.css?v=20260811frontend2')
    expect(adminHtml).toContain('/admin/styles.css?v=20260811frontend2')
  })
})
