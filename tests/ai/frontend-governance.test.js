...
describe('AI governance navigation and DOM contract', () => {
  ...
  it('restores the dedicated user-scoped system audit workspace', () => {
    ...
    expect(app).toContain('compactTerminalTimeHtml(row?.created_at_mt5)')
    expect(app).toContain('compactTerminalTimeHtml(signal?.created_at_mt5)')
    expect(app).toContain('compactTerminalTimeText(signal?.created_at_mt5)')
