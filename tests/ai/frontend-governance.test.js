...
describe('AI governance navigation and DOM contract', () => {
  ...
  it('provides the unified user and administrator information architecture', () => {
    ...
    for (const tab of ['global-risk', 'audit']) expect(html).toContain(`id="${tab}"`)
    expect(html).toContain('href="/admin/?view=ai-operations"')
    expect(html).toContain('href="/admin/?view=risk-audit"')
    expect(html).not.toContain('data-tab="admin-dashboard"')
    expect(app).toContain("navGroupManage.style.display = isAdmin ? '' : 'none';")
  ...
  it('organizes the administrator operations center around health, actions, users, and releases', () => {
    ...
    expect(app).toContain("data-admin-view=\"notifications\"")
    ...
    expect(responsiveCss).toContain('.ops-notification-table td::before')
