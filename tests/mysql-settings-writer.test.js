...
import { createSettingsWriter, settingsTargetFields } from '../scripts/lib/mysql-settings-writer.mjs'
function fixture() {
  const { row, options } = settingsFixture(), writer = createSettingsWriter([row], options)
