...
| 真实 MT5 成交增量上传 | 已通过 | epoch 23 以 7 个 revision 上传 7 天窗口内 48 条真实成交；MySQL 中 48 个唯一 ticket，本地等待确认成交和成交 Outbox 均为 0 |
...
| 7 天内存增长不超过 5% | 验收工具已完成，未达到时间窗口 | `Measure-BridgeHealth.ps1` 当前因真实样本仅 1.259 小时而失败关闭 |
