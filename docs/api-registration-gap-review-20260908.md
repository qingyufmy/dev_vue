...
更新：第八批已同步修复29项 handler 参数命名，并补认证中心两个接口合同与行为校验。[v2机器明细](migration/api-route-coverage-20260908-v2.json)为95项合同、87项注册、87项匹配，未声明和参数差异均为0，缺失仍为8。以下原始数字保留为第一轮基线。认证中心错误响应当前使用 application/json，其媒体类型标准化尚未完成。
