...
function renderPendingOrders(orders) {
  ...
  tbody.innerHTML = orders.map((o) => {
    ...
    const quote = state.lastQuote;
    const currentPrice = (quote && quote.symbol === o.symbol) ? (o.side === "buy" ? quote.ask : quote.bid) : null;
    return `<tr>
      ...
      <td class="num">${currentPrice ? Number(currentPrice).toFixed(2) : "<small class='text-muted'>加载中</small>"}</td>
