...
async function openObserverSourceEditor(source=null){
  const data=await loadObserverCandidates(),selectedUserId=Number(source?.bridge_user_id||data.candidates[0]?.id||0)
