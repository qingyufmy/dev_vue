...
function contentTabs(){return `<nav class="segment-tabs" aria-label="内容与系统分类"><button class="segment-tab ${state.contentTab==='courses'?'is-active':''}" data-content-tab="courses" type="button">课程内容</button><button class="segment-tab ${state.contentTab==='assets'?'is-active':''}" data-content-tab="assets" type="button">测验与资料</button><button class="segment-tab ${state.contentTab==='engagement'?'is-active':''}" data-content-tab="engagement" type="button">学习与社区</button><button class="segment-tab ${state.contentTab==='feedback'?'is-active':''}" data-content-tab="feedback" type="button">用户反馈</button><button class="segment-tab ${state.contentTab==='system'?'is-active':''}" data-content-tab="system" type="button">系统发布</button></nav>`}
...
async function renderContentTab(){if(state.contentTab==='assets')await loadCourseAssets();else if(state.contentTab==='engagement')await renderContentEngagement();else if(state.contentTab==='feedback')await renderContentFeedback();else if(state.contentTab==='system'){if(!state.contentOverview)await loadContentOverview();else renderContentSystem()}else await renderContentCourses()}
