...
function openPlatformModelEditor(profile=null) {
  ...
  if(requestLimitField){requestLimitField.querySelector('span').textContent='单次请求安全上限（毫秒）';requestLimitField.insertAdjacentHTML('beforeend','<small class="field-help">仅用于阻止连接无限挂起。日/月复盘有独立任务期限、租约续期与恢复机制。</small>')}
